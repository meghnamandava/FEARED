...
overlay = Overlay('/home/xilinx/jupyter_notebooks/Final/design_1_op.bit')
...
text_buffer = xlnk.cma_array(shape=(4096,), dtype=np.int16)
...
return_buffer = xlnk.cma_array(shape=(4096,), dtype=np.int16)

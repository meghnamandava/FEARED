...
entity aes_expand_key_rcon_rom is 
    generic(
             DWIDTH     : integer := 8; 
             AWIDTH     : integer := 8; 
...
architecture rtl of aes_expand_key_rcon_rom is 
...
signal mem : mem_array := (
    ...
    252 => "01110100", 253 => "11101000", 254 => "11001011", 255 => "10001101" );
...
architecture arch of aes_expand_key_rcon is
    component aes_expand_key_rcon_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    aes_expand_key_rcon_rom_U :  component aes_expand_key_rcon_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,

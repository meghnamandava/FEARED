...
architecture behave of xts_aes_ctrl_s_axi is
    ...
    signal int_key_V           : UNSIGNED(31 downto 0) := (others => '0');
    signal int_tweak_V         : UNSIGNED(31 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_TWEAK_V_DATA_0 =>
                        rdata_data <= RESIZE(int_tweak_V(31 downto 0), 32);
                    when ADDR_TEXT_V_DATA_0 =>
                        rdata_data <= RESIZE(int_text_V(31 downto 0), 32);
...
-- ----------------------- Register logic ----------------
    ...
    tweak_V              <= STD_LOGIC_VECTOR(int_tweak_V);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_TWEAK_V_DATA_0) then
                    int_tweak_V(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_tweak_V(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_TEXT_V_DATA_0) then
                    int_text_V(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_text_V(31 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_MODE_V_DATA_0) then
                    int_mode_V(15 downto 0) <= (UNSIGNED(WDATA(15 downto 0)) and wmask(15 downto 0)) or ((not wmask(15 downto 0)) and int_mode_V(15 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_DATA_RET_V_DATA_0) then
                    int_data_ret_V(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_data_ret_V(31 downto 0));
                end if;
            end if;
        end if;
    end process;

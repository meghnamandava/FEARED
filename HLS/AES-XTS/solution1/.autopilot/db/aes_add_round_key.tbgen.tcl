...
set C_modelArgList {
	...
	{ round_key_matrix_V int 16 regular {array 16 { 1 3 } 1 1 }  }
}
...
set Spec2ImplPortList { 
	...
	round_key_matrix_V { ap_memory {  { round_key_matrix_V_address0 mem_address 1 4 }  { round_key_matrix_V_ce0 mem_ce 1 1 }  { round_key_matrix_V_q0 mem_dout 0 16 } } }
}

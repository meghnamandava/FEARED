set moduleName aes_add_round_key
set isTopModule 0
...
set C_modelName {aes_add_round_key}
set C_modelType { void 0 }
set C_modelArgList {
	{ state_matrix_V int 16 regular {array 16 { 2 2 } 1 1 }  }
	{ round_key_matrix_V int 16 regular {array 16 { 1 1 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "state_matrix_V", "interface" : "memory", "bitwidth" : 16, "direction" : "READWRITE"} , 
 	{ "Name" : "round_key_matrix_V", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ round_key_matrix_V_address0 sc_out sc_lv 4 signal 1 } 
	{ round_key_matrix_V_ce0 sc_out sc_logic 1 signal 1 } 
	{ round_key_matrix_V_q0 sc_in sc_lv 16 signal 1 } 
	{ round_key_matrix_V_address1 sc_out sc_lv 4 signal 1 } 
	{ round_key_matrix_V_ce1 sc_out sc_logic 1 signal 1 } 
	{ round_key_matrix_V_q1 sc_in sc_lv 16 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "round_key_matrix_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "round_key_matrix_V", "role": "address0" }} , 
 	{ "name": "round_key_matrix_V_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "round_key_matrix_V", "role": "ce0" }} , 
 	{ "name": "round_key_matrix_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "round_key_matrix_V", "role": "q0" }} , 
 	{ "name": "round_key_matrix_V_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "round_key_matrix_V", "role": "address1" }} , 
 	{ "name": "round_key_matrix_V_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "round_key_matrix_V", "role": "ce1" }} , 
 	{ "name": "round_key_matrix_V_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "round_key_matrix_V", "role": "q1" }}  ]}
...
set Spec2ImplPortList { 
	...
	round_key_matrix_V { ap_memory {  { round_key_matrix_V_address0 mem_address 1 4 }  { round_key_matrix_V_ce0 mem_ce 1 1 }  { round_key_matrix_V_q0 mem_dout 0 16 }  { round_key_matrix_V_address1 MemPortADDR2 1 4 }  { round_key_matrix_V_ce1 MemPortCE2 1 1 }  { round_key_matrix_V_q1 MemPortDOUT2 0 16 } } }
}

...
`define AUTOTB_TVIN_data0  "./c.xts_aes.autotvin_data0.dat"
`define AUTOTB_TVIN_data1  "./c.xts_aes.autotvin_data1.dat"
`define AUTOTB_TVIN_data2  "./c.xts_aes.autotvin_data2.dat"
`define AUTOTB_TVIN_key_V  "./c.xts_aes.autotvin_key_V.dat"
`define AUTOTB_TVIN_tweak_V  "./c.xts_aes.autotvin_tweak_V.dat"
`define AUTOTB_TVIN_text_V  "./c.xts_aes.autotvin_text_V.dat"
`define AUTOTB_TVIN_mode_V  "./c.xts_aes.autotvin_mode_V.dat"
`define AUTOTB_TVIN_text_len_V  "./c.xts_aes.autotvin_text_len_V.dat"
`define AUTOTB_TVIN_data_ret_V  "./c.xts_aes.autotvin_data_ret_V.dat"
`define AUTOTB_TVIN_data0_out_wrapc  "./rtl.xts_aes.autotvin_data0.dat"
`define AUTOTB_TVIN_data1_out_wrapc  "./rtl.xts_aes.autotvin_data1.dat"
`define AUTOTB_TVIN_data2_out_wrapc  "./rtl.xts_aes.autotvin_data2.dat"
`define AUTOTB_TVIN_key_V_out_wrapc  "./rtl.xts_aes.autotvin_key_V.dat"
`define AUTOTB_TVIN_tweak_V_out_wrapc  "./rtl.xts_aes.autotvin_tweak_V.dat"
`define AUTOTB_TVIN_text_V_out_wrapc  "./rtl.xts_aes.autotvin_text_V.dat"
`define AUTOTB_TVIN_mode_V_out_wrapc  "./rtl.xts_aes.autotvin_mode_V.dat"
`define AUTOTB_TVIN_text_len_V_out_wrapc  "./rtl.xts_aes.autotvin_text_len_V.dat"
`define AUTOTB_TVIN_data_ret_V_out_wrapc  "./rtl.xts_aes.autotvin_data_ret_V.dat"
`define AUTOTB_TVOUT_data3  "./c.xts_aes.autotvout_data3.dat"
`define AUTOTB_TVOUT_data3_out_wrapc  "./impl_rtl.xts_aes.autotvout_data3.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 2;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 327889;

...
set portList { 
	...
	{ multiplication_V_offset sc_in sc_lv 31 signal 7 } 
	{ sequence_out_V_address0 sc_out sc_lv 4 signal 8 } 
	{ sequence_out_V_ce0 sc_out sc_logic 1 signal 8 } 
	{ sequence_out_V_we0 sc_out sc_logic 1 signal 8 } 
	{ sequence_out_V_d0 sc_out sc_lv 16 signal 8 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "6", "7", "8", "9"],
		"CDFG" : "aes_process_1",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			{"Name" : "text_V", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "7", "SubInstance" : "grp_aes_sequence_to_matr_fu_241", "Port" : "sequence_V"},
					{"ID" : "3", "SubInstance" : "grp_aes_mix_columns84142_1_fu_213", "Port" : "multiplication_V"}]},
			{"Name" : "text_V_offset", "Type" : "None", "Direction" : "I"},
			{"Name" : "expanded_key_V", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "grp_aes_get_round_key5_fu_251", "Port" : "expanded_key_V"}]},
			{"Name" : "s_boxes_V", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "6", "SubInstance" : "grp_aes_substitute_bytes_fu_231", "Port" : "s_box_V"}]},
			{"Name" : "s_boxes_V_offset", "Type" : "None", "Direction" : "I"},
			{"Name" : "mix_column_constant_matrices_V", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "grp_aes_mix_columns84142_1_fu_213", "Port" : "constant_matrix_V"}]},
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_aes_mix_columns84142_1_fu_213", "Parent" : "0",
		...
		"Port" : [
			...
			{"Name" : "multiplication_V_offset", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_aes_shift_rows_fu_224", "Parent" : "0", "Child" : ["5"],
		"CDFG" : "aes_shift_rows",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
	...
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_aes_shift_rows_fu_224.xts_aes_mux_42_16cud_U37", "Parent" : "4"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_aes_substitute_bytes_fu_231", "Parent" : "0",
	...
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_aes_sequence_to_matr_fu_241", "Parent" : "0",
	...
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_aes_get_round_key5_fu_251", "Parent" : "0",
	...
	{"ID" : "9", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_aes_add_round_key_fu_262", "Parent" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "10423", "Max" : "10969"}
	, {"Name" : "Interval", "Min" : "10423", "Max" : "10969"}
]}

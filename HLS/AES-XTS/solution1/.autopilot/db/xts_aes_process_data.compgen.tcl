...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_data_V \
    op interface \
    ports { m_axi_data_V_AWVALID { O 1 bit } m_axi_data_V_AWREADY { I 1 bit } m_axi_data_V_AWADDR { O 32 vector } m_axi_data_V_AWID { O 1 vector } m_axi_data_V_AWLEN { O 32 vector } m_axi_data_V_AWSIZE { O 3 vector } m_axi_data_V_AWBURST { O 2 vector } m_axi_data_V_AWLOCK { O 2 vector } m_axi_data_V_AWCACHE { O 4 vector } m_axi_data_V_AWPROT { O 3 vector } m_axi_data_V_AWQOS { O 4 vector } m_axi_data_V_AWREGION { O 4 vector } m_axi_data_V_AWUSER { O 1 vector } m_axi_data_V_WVALID { O 1 bit } m_axi_data_V_WREADY { I 1 bit } m_axi_data_V_WDATA { O 64 vector } m_axi_data_V_WSTRB { O 8 vector } m_axi_data_V_WLAST { O 1 bit } m_axi_data_V_WID { O 1 vector } m_axi_data_V_WUSER { O 1 vector } m_axi_data_V_ARVALID { O 1 bit } m_axi_data_V_ARREADY { I 1 bit } m_axi_data_V_ARADDR { O 32 vector } m_axi_data_V_ARID { O 1 vector } m_axi_data_V_ARLEN { O 32 vector } m_axi_data_V_ARSIZE { O 3 vector } m_axi_data_V_ARBURST { O 2 vector } m_axi_data_V_ARLOCK { O 2 vector } m_axi_data_V_ARCACHE { O 4 vector } m_axi_data_V_ARPROT { O 3 vector } m_axi_data_V_ARQOS { O 4 vector } m_axi_data_V_ARREGION { O 4 vector } m_axi_data_V_ARUSER { O 1 vector } m_axi_data_V_RVALID { I 1 bit } m_axi_data_V_RREADY { O 1 bit } m_axi_data_V_RDATA { I 64 vector } m_axi_data_V_RLAST { I 1 bit } m_axi_data_V_RID { I 1 vector } m_axi_data_V_RUSER { I 1 vector } m_axi_data_V_RRESP { I 2 vector } m_axi_data_V_BVALID { I 1 bit } m_axi_data_V_BREADY { O 1 bit } m_axi_data_V_BRESP { I 2 vector } m_axi_data_V_BID { I 1 vector } m_axi_data_V_BUSER { I 1 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { data_V_offset { I 29 vector } } \
} "
}

...
HLS_SOURCES = ../../../aesxts_test.cpp ../../../main.cpp
...
$(ObjDir)/aesxts_test.o: ../../../aesxts_test.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../aesxts_test.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/aesxts_test.d

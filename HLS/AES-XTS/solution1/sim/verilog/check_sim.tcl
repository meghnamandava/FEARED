...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.xts_aes.autotvin_data0.dat"
         "c.xts_aes.autotvin_data1.dat"
         "c.xts_aes.autotvin_data2.dat"
         "c.xts_aes.autotvin_key_V.dat"
         "c.xts_aes.autotvin_tweak_V.dat"
         "c.xts_aes.autotvin_text_V.dat"
         "c.xts_aes.autotvin_mode_V.dat"
         "c.xts_aes.autotvin_text_len_V.dat"
         "c.xts_aes.autotvin_data_ret_V.dat"
         "c.xts_aes.autotvout_data3.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.xts_aes.autotvout_data3.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {

...
module AESL_axi_master_data3 (
    ...
    TRAN_data3_BID,
    TRAN_data3_BUSER,
    TRAN_data3_data_ret_V,
    ready,
    done
    );

//------------------------Parameter----------------------
`define TV_IN_data3 "../tv/cdatafile/c.xts_aes.autotvin_data3.dat"
`define TV_OUT_data3 "../tv/rtldatafile/rtl.xts_aes.autotvout_data3.dat"
 parameter data3_ADDR_BITWIDTH = 32'd 32;
 parameter data3_AWUSER_BITWIDTH = 32'd 1;
 parameter data3_DATA_BITWIDTH = 32'd 32;
 parameter data3_WUSER_BITWIDTH = 32'd 1;
 parameter data3_ID_BITWIDTH = 32'd 1;
 parameter data3_RUSER_BITWIDTH = 32'd 1;
 parameter data3_BUSER_BITWIDTH = 32'd 1;
 parameter   FIFO_DEPTH            =   1 + 1;
 parameter   mem_page_num            =   32'd 3;
 parameter   FIFO_DEPTH_ADDR_WIDTH   =    32'd 32;
parameter data3_C_DATA_BITWIDTH = 32'd 16;
parameter data3_mem_depth = 32'd 1024;
parameter ReadReqLatency = 32'd 1;
parameter WriteReqLatency = 32'd 1;
// Input and Output
input clk;
input reset;
input  TRAN_data3_AWVALID;
output  TRAN_data3_AWREADY;
input [data3_ADDR_BITWIDTH - 1 : 0] TRAN_data3_AWADDR;
input [data3_ID_BITWIDTH - 1 : 0] TRAN_data3_AWID;
input [8 - 1 : 0] TRAN_data3_AWLEN;
input [3 - 1 : 0] TRAN_data3_AWSIZE;
input [2 - 1 : 0] TRAN_data3_AWBURST;
input [2 - 1 : 0] TRAN_data3_AWLOCK;
input [4 - 1 : 0] TRAN_data3_AWCACHE;
input [3 - 1 : 0] TRAN_data3_AWPROT;
input [4 - 1 : 0] TRAN_data3_AWQOS;
input [4 - 1 : 0] TRAN_data3_AWREGION;
input [data3_AWUSER_BITWIDTH - 1 : 0] TRAN_data3_AWUSER;
input  TRAN_data3_WVALID;
output  TRAN_data3_WREADY;
input [data3_DATA_BITWIDTH - 1 : 0] TRAN_data3_WDATA;
input [data3_DATA_BITWIDTH/8 - 1 : 0] TRAN_data3_WSTRB;
input  TRAN_data3_WLAST;
input  TRAN_data3_WID;
input [data3_WUSER_BITWIDTH - 1 : 0] TRAN_data3_WUSER;
input  TRAN_data3_ARVALID;
output  TRAN_data3_ARREADY;
input [data3_ADDR_BITWIDTH - 1 : 0] TRAN_data3_ARADDR;
input [data3_ID_BITWIDTH - 1 : 0] TRAN_data3_ARID;
input [8 - 1 : 0] TRAN_data3_ARLEN;
input [3 - 1 : 0] TRAN_data3_ARSIZE;
input [2 - 1 : 0] TRAN_data3_ARBURST;
input [2 - 1 : 0] TRAN_data3_ARLOCK;
input [4 - 1 : 0] TRAN_data3_ARCACHE;
input [3 - 1 : 0] TRAN_data3_ARPROT;
input [4 - 1 : 0] TRAN_data3_ARQOS;
input [4 - 1 : 0] TRAN_data3_ARREGION;
input  TRAN_data3_ARUSER;
output  TRAN_data3_RVALID;
input  TRAN_data3_RREADY;
output [data3_DATA_BITWIDTH - 1 : 0] TRAN_data3_RDATA;
output  TRAN_data3_RLAST;
output [data3_ID_BITWIDTH - 1 : 0] TRAN_data3_RID;
output [data3_RUSER_BITWIDTH - 1 : 0] TRAN_data3_RUSER;
output [2 - 1 : 0] TRAN_data3_RRESP;
output  TRAN_data3_BVALID;
input  TRAN_data3_BREADY;
output [2 - 1 : 0] TRAN_data3_BRESP;
output [data3_ID_BITWIDTH - 1 : 0] TRAN_data3_BID;
output [data3_BUSER_BITWIDTH - 1 : 0] TRAN_data3_BUSER;
output [32 - 1 : 0] TRAN_data3_data_ret_V;
input ready;
input done;

// Inner signals
// AW request fifo
reg    [data3_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [data3_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR_tmp; 
...
// AR request fifo
reg    [data3_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [data3_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR_tmp; 
...
// WDATA fifo
reg    [data3_DATA_BITWIDTH - 1 : 0]         FIFO_WDATA           [0 : FIFO_DEPTH - 1]; 
reg    [data3_DATA_BITWIDTH/8 - 1 : 0]       FIFO_WSTRB           [0 : FIFO_DEPTH - 1]; 
...
reg [data3_DATA_BITWIDTH - 1:0] RDATA_tmp = 0;
reg [2 - 1:0] RRESP_tmp = 0;
reg RLAST_tmp = 0;
reg RVALID_tmp = 0;
reg [32 - 1 : 0] data_ret_V = 0;
reg [data3_DATA_BITWIDTH - 1 : 0] data3_mem_0 [0: data3_mem_depth - 1]; 
reg [data3_DATA_BITWIDTH - 1 : 0] data3_mem_1 [0: data3_mem_depth - 1]; 
reg [data3_DATA_BITWIDTH - 1 : 0] data3_mem_2 [0: data3_mem_depth - 1]; 
reg [31 : 0] clk_counter ;
reg [31 : 0] current_AW_req_transaction = 0 ;
reg [31 : 0] current_AR_req_transaction = -1 ;
reg write_processing = 0;
reg [data3_ADDR_BITWIDTH - 1 : 0] wr_processing_addr = 0;
reg [data3_ADDR_BITWIDTH - 1 : 0] rd_processing_addr = 0;
reg [31 : 0] wr_processing_trans_num = 0;
reg [data3_DATA_BITWIDTH - 1 : 0] wr_processing_data = 0;
assign TRAN_data3_AWREADY    =    !FIFO_AW_req_full; 
assign TRAN_data3_ARREADY    =    !FIFO_AR_req_full; 
assign TRAN_data3_WREADY    =     !(FIFO_WDATA_req_full || FIFO_WDATA_size_full); 
assign TRAN_data3_BVALID = (BRESP_counter == 0) ? 0 : 1;
assign TRAN_data3_BRESP = BRESP_tmp;
assign TRAN_data3_RDATA = RDATA_tmp;
assign TRAN_data3_RRESP = RRESP_tmp;
assign TRAN_data3_RLAST = RLAST_tmp;
assign TRAN_data3_RVALID = RVALID_tmp;
assign    TRAN_data3_data_ret_V = data_ret_V;

initial begin : initialize_offset
  integer DATA_byte_num; 
  integer c_bitwidth;
  DATA_byte_num = 0; 
  c_bitwidth = data3_C_DATA_BITWIDTH;
  count_c_data_byte_num_by_bitwidth (c_bitwidth , DATA_byte_num);
  data_ret_V <= 0 * DATA_byte_num;
end

initial begin : initialize_data3_mem
  integer i;
  for (i = 0; i < data3_mem_depth; i = i + 1) begin
      data3_mem_0[i] = 0;
      data3_mem_1[i] = 0;
      data3_mem_2[i] = 0;
  end
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_data3_AWREADY & TRAN_data3_AWVALID ) begin    // RTL is sending a AW_request to the bus         
            FIFO_AW_req_SIZE [FIFO_AW_req_ptr_w]    =   TRAN_data3_AWSIZE; 
            FIFO_AW_req_ADDR [FIFO_AW_req_ptr_w]    =   TRAN_data3_AWADDR; 
            FIFO_AW_req_LEN  [FIFO_AW_req_ptr_w]    =   TRAN_data3_AWLEN; 
            FIFO_AW_req_BURST[FIFO_AW_req_ptr_w]    =   TRAN_data3_AWBURST; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_data3_ARREADY & TRAN_data3_ARVALID ) begin    // RTL is sending a AR_request to the bus         
            FIFO_AR_req_SIZE [FIFO_AR_req_ptr_w]    =   TRAN_data3_ARSIZE; 
            FIFO_AR_req_ADDR [FIFO_AR_req_ptr_w]    =   TRAN_data3_ARADDR; 
            FIFO_AR_req_LEN  [FIFO_AR_req_ptr_w]    =   TRAN_data3_ARLEN; 
            FIFO_AR_req_BURST[FIFO_AR_req_ptr_w]    =   TRAN_data3_ARBURST; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_data3_WREADY & TRAN_data3_WVALID) begin    // RTL is sending a WDATA data 
            FIFO_WDATA [FIFO_WDATA_req_ptr_w]    <=   TRAN_data3_WDATA; 
            FIFO_WSTRB [FIFO_WDATA_req_ptr_w]    <=   TRAN_data3_WSTRB; 
            if(FIFO_WDATA_req_ptr_w != FIFO_DEPTH - 1) 
                FIFO_WDATA_req_ptr_w <= FIFO_WDATA_req_ptr_w + 1; 
            else 
                FIFO_WDATA_req_ptr_w <= 0; 
            if (TRAN_data3_WLAST == 1 ) begin
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_data3_AWVALID && TRAN_data3_AWREADY && ((FIFO_AW_req_ptr_w - FIFO_AW_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AW_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_data3_ARVALID && TRAN_data3_ARREADY && ((FIFO_AR_req_ptr_w - FIFO_AR_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AR_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_data3_WVALID && TRAN_data3_WREADY && ((FIFO_WDATA_req_ptr_w - FIFO_WDATA_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_data3_WVALID && TRAN_data3_WREADY && TRAN_data3_WLAST && ((FIFO_WDATA_size_ptr_w - FIFO_WDATA_size_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if ( send_one_BRESP == 'b1 && !(BRESP_counter != 32'h0 && TRAN_data3_BREADY) ) begin
            BRESP_counter <= BRESP_counter + 1;
        end else if (send_one_BRESP != 'b1 && (BRESP_counter != 32'h0 && TRAN_data3_BREADY)) begin
            BRESP_counter <= BRESP_counter - 1;
        end
    end
end
...
initial begin : AW_request_proc
    ...
    reg [data3_DATA_BITWIDTH - 1 : 0] FIFO_WDATA_tmp;
    reg [data3_DATA_BITWIDTH - 1 : 0] WDATA_tmp;
    reg [data3_DATA_BITWIDTH/8 - 1 : 0] FIFO_WSTRB_tmp;
    @(posedge clk);
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > data3_mem_depth) begin
                $display ("C:/Users/meghn/ECE527_Final_Project/HLS/AES-XTS/solution1/sim/verilog/AESL_axi_master_data3.v: Write request address %d exceed AXI master data3 array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, data3_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AW_req_BURST_tmp === 1) begin
                ...
                while (counter != output_length + 1) begin
                    if (FIFO_WDATA_req_empty != 1) begin 
                            ...
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = data3_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        1 : WDATA_tmp[j] = data3_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        2 : WDATA_tmp[j] = data3_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                        ...
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : data3_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            1 : data3_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            2 : data3_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
                    ...
                    if (FIFO_WDATA_req_empty != 1) begin 
                        ...
                        for (i = 0 ; i < data_byte_size; i = i + 1) begin
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = data3_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        1 : WDATA_tmp[j] = data3_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        2 : WDATA_tmp[j] = data3_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        default: $display("The page_num of AXI write is not valid!");
                                    endcase
                                end
                            end
                        ...
                        wr_processing_data = WDATA_tmp;
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : data3_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            1 : data3_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            2 : data3_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
...
initial begin : AR_request_proc
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > data3_mem_depth) begin
                $display ("C:/Users/meghn/ECE527_Final_Project/HLS/AES-XTS/solution1/sim/verilog/AESL_axi_master_data3.v: Read request address %d exceed AXI master data3 array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, data3_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AR_req_BURST_tmp === 1) begin
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= data3_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            1 : RDATA_tmp <= data3_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            2 : RDATA_tmp <= data3_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                    ...
                    @(posedge clk);
                    if (RVALID_tmp && TRAN_data3_RREADY) begin
                        counter = counter + 1;
                    end 
                end
                RVALID_tmp <= 0;
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= data3_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            1 : RDATA_tmp <= data3_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            2 : RDATA_tmp <= data3_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            default: $display("The page_num of AXI read is not valid!");
                        endcase
                    RVALID_tmp <= 1;
                    RRESP_tmp <= 0;
...
initial begin : read_file_process 
  ...
  integer mem_page; 
  integer data3_bitwidth; 
  reg [127 : 0] token; 
  reg [127 : 0] token_tmp; 
  //reg [data3_C_DATA_BITWIDTH - 1 : 0] token_tmp; 
  reg [data3_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  integer i; 
  transaction_num = 0;
  data3_bitwidth = data3_C_DATA_BITWIDTH; 
  count_seperate_factor_by_bitwidth (data3_bitwidth , factor);
  fp = $fopen(`TV_IN_data3,"r"); 
  if(fp == 0) begin                               // Failed to open file 
      $display("Failed to open file \"%s\"!", `TV_IN_data3); 
      $finish; 
  end 
  token = read_token(fp); 
  ...
  while (token != "[[[/runtime]]]") begin 
      ...
      mem_tmp [data3_DATA_BITWIDTH - 1: 0] = 0;
      for(i = 0; i < 1024 ; i = i + 1) begin 
          ...
          if (factor == 4) begin
              ...
              if (i%factor == 3) begin
                  ...
                  case(mem_page)
                      0 : data3_mem_0[i/factor] = mem_tmp;
                      1 : data3_mem_1[i/factor] = mem_tmp;
                      2 : data3_mem_2[i/factor] = mem_tmp;
          ...
          if (factor == 1) begin
              mem_tmp = token_tmp;
              case(mem_page)
                  0 : data3_mem_0[i] = mem_tmp;
                  1 : data3_mem_1[i] = mem_tmp;
                  2 : data3_mem_2[i] = mem_tmp;
                  default: $display("The page_num of read file is not valid!");
              endcase
              mem_tmp [data3_DATA_BITWIDTH - 1: 0] = 0;
          end
...
initial begin : write_file_proc 
  ...
  integer mem_page; 
  integer data3_bitwidth; 
  reg [data3_C_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  reg [data3_DATA_BITWIDTH - 1 : 0] tmp_data;
  transaction_num = 0; 
  data3_bitwidth = data3_C_DATA_BITWIDTH; 
  count_seperate_factor_by_bitwidth (data3_bitwidth , factor);
  while(1) begin 
      ...
      mem_page = transaction_num % mem_page_num ;
      # 0.1;
      fp = $fopen(`TV_OUT_data3, "a"); 
      if(fp == 0) begin       // Failed to open file 
          $display("Failed to open file \"%s\"!", `TV_OUT_data3); 
          $finish; 
      end 
      $fdisplay(fp, "[[transaction]] %d", transaction_num);
      for(i = 0; i < (data3_mem_depth - data3_mem_depth % factor); i = i + 1) begin 
          if (factor == 4) begin
              case(mem_page)
                  0 : tmp_data = data3_mem_0[i/factor];
                  1 : tmp_data = data3_mem_1[i/factor];
                  2 : tmp_data = data3_mem_2[i/factor];
          ...
          if (factor == 1) begin
              case(mem_page)
                  0 : mem_tmp = data3_mem_0[i];
                  1 : mem_tmp = data3_mem_1[i];
                  2 : mem_tmp = data3_mem_2[i];
                  default: $display("The page_num of write file is not valid!");
              endcase
              $fdisplay(fp,"0x%x",mem_tmp);
          end
      ...
      if (factor == 4) begin
          case(mem_page)
              0 : tmp_data = data3_mem_0[data3_mem_depth/factor];
              1 : tmp_data = data3_mem_1[data3_mem_depth/factor];
              2 : tmp_data = data3_mem_2[data3_mem_depth/factor];
              default: $display("The page_num of write file is not valid!");
          endcase
          if ((data3_mem_depth - 1) % factor == 2) begin
              $fdisplay(fp,"0x%x",tmp_data[7:0]);
              $fdisplay(fp,"0x%x",tmp_data[15:8]);
              $fdisplay(fp,"0x%x",tmp_data[23:16]);
          end
          if ((data3_mem_depth - 1) % factor == 1) begin
              $fdisplay(fp,"0x%x",tmp_data[7:0]);
              $fdisplay(fp,"0x%x",tmp_data[15:8]);
          end
          if ((data3_mem_depth - 1) % factor == 0) begin
              $fdisplay(fp,"0x%x",tmp_data[7:0]);
          end
      end
      if (factor == 2) begin
          if ((data3_mem_depth - 1) % factor == 0) begin
              case(mem_page)
                  0 : $fdisplay(fp,"0x%x",data3_mem_0[data3_mem_depth/factor][15:0]);
                  1 : $fdisplay(fp,"0x%x",data3_mem_1[data3_mem_depth/factor][15:0]);
                  2 : $fdisplay(fp,"0x%x",data3_mem_2[data3_mem_depth/factor][15:0]);
                  default: $display("The page_num of write file is not valid!");
              endcase
          end
      end

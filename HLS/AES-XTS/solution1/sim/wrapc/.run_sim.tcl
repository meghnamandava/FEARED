...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "xts_aes.autotvin.dat"
	set constFileTvOut       "xts_aes.autotvout.dat"
	set constFileHdlTvIn     "xts_aes.autohdltvin.dat"
	set constFileHdlTvOut    "xts_aes.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

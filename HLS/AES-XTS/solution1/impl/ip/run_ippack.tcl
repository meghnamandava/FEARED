...
set IPName      "xts_aes"
set Version     "1.0"
set DisplayName "Xts_aes"
set Revision    "2112131549"
...
set sdx_kernel_name "xts_aes"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. sdaccel]
set solution_dir "C:/Users/meghn/ECE527_Final_Project/HLS/AES-XTS/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {xts_aes_mux_42_16cud
aes_expand_key_rcon
...
set Interfaces {
    s_axi_ctrl {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 key_V W 0x0 "Data signal of key_V" {{0 32 key_V W 0 "Bit 31 to 0 Data signal of key_V"}}} {0x18 tweak_V W 0x0 "Data signal of tweak_V" {{0 32 tweak_V W 0 "Bit 31 to 0 Data signal of tweak_V"}}} {0x20 text_V W 0x0 "Data signal of text_V" {{0 32 text_V W 0 "Bit 31 to 0 Data signal of text_V"}}} {0x28 mode_V W 0x0 "Data signal of mode_V" {{0 16 mode_V W 0 "Bit 15 to 0 Data signal of mode_V"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 text_len_V W 0x0 "Data signal of text_len_V" {{0 16 text_len_V W 0 "Bit 15 to 0 Data signal of text_len_V"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 data_ret_V W 0x0 "Data signal of data_ret_V" {{0 32 data_ret_V W 0 "Bit 31 to 0 Data signal of data_ret_V"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_ctrl m_axi_data0 m_axi_data1 m_axi_data2 m_axi_data3"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_data3 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_data3"
        data_width "32"
        param_prefix "C_M_AXI_DATA3"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 13783 II x}

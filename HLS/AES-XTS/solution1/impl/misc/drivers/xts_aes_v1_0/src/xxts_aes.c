...
void XXts_aes_Set_s_boxes_V(XXts_aes *InstancePtr, u32 Data) {
    ...
    XXts_aes_WriteReg(InstancePtr->Ctrl_BaseAddress, XXTS_AES_CTRL_ADDR_S_BOXES_V_DATA, Data);
}
...
u32 XXts_aes_Get_s_boxes_V(XXts_aes *InstancePtr) {
    ...
    Data = XXts_aes_ReadReg(InstancePtr->Ctrl_BaseAddress, XXTS_AES_CTRL_ADDR_S_BOXES_V_DATA);
    return Data;
}
...
void XXts_aes_Set_mix_column_constant_matrices_V(XXts_aes *InstancePtr, u32 Data) {
    ...
    XXts_aes_WriteReg(InstancePtr->Ctrl_BaseAddress, XXTS_AES_CTRL_ADDR_MIX_COLUMN_CONSTANT_MATRICES_V_DATA, Data);
}
...
u32 XXts_aes_Get_mix_column_constant_matrices_V(XXts_aes *InstancePtr) {
    ...
    Data = XXts_aes_ReadReg(InstancePtr->Ctrl_BaseAddress, XXTS_AES_CTRL_ADDR_MIX_COLUMN_CONSTANT_MATRICES_V_DATA);
    return Data;
}
...
void XXts_aes_Set_multiplication_V(XXts_aes *InstancePtr, u32 Data) {
    ...
    XXts_aes_WriteReg(InstancePtr->Ctrl_BaseAddress, XXTS_AES_CTRL_ADDR_MULTIPLICATION_V_DATA, Data);
}
...
u32 XXts_aes_Get_multiplication_V(XXts_aes *InstancePtr) {
    ...
    Data = XXts_aes_ReadReg(InstancePtr->Ctrl_BaseAddress, XXTS_AES_CTRL_ADDR_MULTIPLICATION_V_DATA);
    return Data;
}
...
void XXts_aes_Set_rcon_V(XXts_aes *InstancePtr, u32 Data) {
    ...
    XXts_aes_WriteReg(InstancePtr->Ctrl_BaseAddress, XXTS_AES_CTRL_ADDR_RCON_V_DATA, Data);
}
...
u32 XXts_aes_Get_rcon_V(XXts_aes *InstancePtr) {
    ...
    Data = XXts_aes_ReadReg(InstancePtr->Ctrl_BaseAddress, XXTS_AES_CTRL_ADDR_RCON_V_DATA);
    return Data;
}
